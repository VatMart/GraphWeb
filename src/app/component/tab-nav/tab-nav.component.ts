...
import {GenerateViewComponent} from "./generate-view/generate-view.component";
import {AlgorithmsViewComponent} from "./algorithms-view/algorithms-view.component";
...
export class TabNavComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.items = [
      {label: 'Generate graph', id: 'generation', icon: 'pi pi-wrench', header: 'Graph generation', visible: true},
      {label: 'Input', id: 'input', icon: 'pi pi-pen-to-square', header: 'Input graph data', visible: true},
      {label: 'Algorithms', id: 'algorithms', icon: 'algorithm-icon', header: 'Graph algorithms', customIcon: true, visible: true},
      {label: 'Customization', id: 'customization', icon: 'pi pi-palette', header: 'Graph customization', visible: true},
      {label: 'Output', id: 'output', icon: 'matrix-icon', header: 'Graph output', customIcon: true, visible: true},
    ];
    // Init subscriptions
  ...
  private toggleAlgorithmModeStyles(value: boolean) {
    ...
    if (this.isMobileDevice) {
      ...
      this.onCloseMobileSidebar(event);
    } else {
      this.onCloseLeftSideContainer();
    }
